      ...
      <div className="container mx-auto max-w-5xl px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            <h1 className="text-5xl md:text-6xl font-black leading-none uppercase tracking-tighter">
            ...
            <div className="flex flex-wrap gap-6 pt-4 items-center">
              ...
              <Button variant="ghost" onClick={() => window.alert('La démo sera bientôt disponible !')}>
                Voir la démo
              </Button>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="brutal-card p-6 bg-white rotate-1">
               <div className="space-y-4">
                  ...
                  {[
                    { n: 'Netflix', p: '19,99€', c: 'bg-red-400', s: 'Alerte demain' },
                    ...
                    <div key={i} className="flex justify-between items-center p-3 border-2 border-black bg-gray-50 shadow-[2px_2px_0px_0px_black]">
                      <div className="flex items-center gap-3">
                        <div className={`w-6 h-6 border-2 border-black ${sub.c}`} />
                        <div>
